"""Local egg MJCF wrapper (whole egg geometry)."""
...
ASSET_DIR = OBJECTS_ASSET_DIR / "egg"
DEFAULT_SCALE = xml_default_scale(ASSET_DIR)


class EggObject(MujocoXMLObject):
    def __init__(self, name: str = "egg", scale: float | None = None):
