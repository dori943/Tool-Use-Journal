"""Local sandwich bread A MJCF wrapper."""
...
ASSET_DIR = OBJECTS_ASSET_DIR / "sandwich_bread_a"
DEFAULT_SCALE = xml_default_scale(ASSET_DIR)


class SandwichBreadAObject(MujocoXMLObject):
    def __init__(self, name: str = "bread_a", scale: float | None = None):
