"""Local turkey slice MJCF wrapper."""
...
ASSET_DIR = OBJECTS_ASSET_DIR / "turkey_slice"
DEFAULT_SCALE = xml_default_scale(ASSET_DIR)


class TurkeySliceObject(MujocoXMLObject):
    def __init__(self, name: str = "turkey_slice", scale: float | None = None):
