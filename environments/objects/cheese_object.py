"""Local cheese MJCF wrapper (current asset is a thick block, not a thin slice)."""
...
ASSET_DIR = OBJECTS_ASSET_DIR / "cheese"
DEFAULT_SCALE = xml_default_scale(ASSET_DIR)


class CheeseObject(MujocoXMLObject):
    def __init__(self, name: str = "cheese", scale: float | None = None):
