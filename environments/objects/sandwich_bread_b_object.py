"""Local sandwich bread B MJCF wrapper."""
...
ASSET_DIR = OBJECTS_ASSET_DIR / "sandwich_bread_b"
DEFAULT_SCALE = xml_default_scale(ASSET_DIR)


class SandwichBreadBObject(MujocoXMLObject):
    def __init__(self, name: str = "bread_b", scale: float | None = None):
