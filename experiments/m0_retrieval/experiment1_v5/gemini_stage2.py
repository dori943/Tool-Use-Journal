"""Stage 2: Gemini downstream reasoning over fixed SiPhy cues (+ optional M1 bbox)."""
...
from v5_conditions import PROPERTIES, Condition

# Reuse parent experiment Gemini client without modifying it / without shadowing v4 imports.
...
class Stage2Result:
    ...
    gemini_call_executed: bool = False
        ...
        *,
        ...
        try:
            ...
            return Stage2Result(
                prediction=_empty_pred(),
                prompt_user=prompt,
                gemini_input_tokens=resp.usage.input_tokens,
                gemini_output_tokens=resp.usage.output_tokens,
                gemini_total_tokens=resp.usage.total_tokens,
                gemini_model_call_count=1,
                gemini_call_executed=True,
