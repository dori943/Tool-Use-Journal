...
from planning_b.feasibility import FeasibilityStatus, GeometryCache
from planning_b.models import PlanningPolicy, Subgoal
from planning_b.scene import SceneState, SceneStateUpdater
...
def _scene_ref(state: SearchState):
    ...
    from planning_b.motion_interface import SceneRef
