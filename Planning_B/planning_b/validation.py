...
from planning_b.conditions import EffectConflictError, validate_subgoal_effects
...
from planning_b.models import OrderConstraints, PlanningBRequest
...
def validate_request(request: PlanningBRequest) -> ValidationOutcome:
...
def _validate_contract_references(
    request: PlanningBRequest, id_set: set[str]
) -> list[Rejection]:
