...
from planning_b.blocks import build_blocks
from planning_b.candidate_provider import (
    Candidate,
    CatalogCandidateProvider,
    StaticCandidateProvider,
    filter_candidates,
)
from planning_b.conditions import CheckerRegistry, initial_facts, true_facts
from planning_b.constraints import (
    PlannerAConstraintEngine,
    build_constraint_resolution_trace,
)
from planning_b.diagnostics import (
...
from planning_b.feasibility import (
    AlwaysPassGeometryChecker,
    GeometricFeasibilityChecker,
    GeometryCache,
    StaticFeasibilityChecker,
)
from planning_b.models import ExecutionState, PlanningBRequest
from planning_b.scene import SceneStateUpdater, SymbolicSceneUpdater
from planning_b.search import (
    ParentEdge,
    SearchOutcome,
    SearchProblem,
    SearchStats,
...
from planning_b.serialization import (
    ActionCounts,
    CandidateAssignment,
    CostVectorModel,
    PlanStep,
...
from planning_b.suitability import PhysicsSuitabilityScorer, SuitabilityScorer
from planning_b.transitions import P, TransitionContext
from planning_b.validation import normalized_edges, validate_request

if TYPE_CHECKING:
    from planning_b.replanning import NoGoodSet
...
def plan(
    ...
    *,
    ...
    from planning_b.search import reconstruct_edges
            ...
            if edge.candidate is not None:
                assignments.append(
                    CandidateAssignment(
                        ...
                        ee_selection_source="planning_b",
