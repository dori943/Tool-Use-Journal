"""Normalize GK + M1/M0/robot-spec artifacts into a Planning-B request.
...
from planning_b.planner_a_adapter import _merge_resource_catalog
    ...
    if selected is None:
        if candidate_values or _rough_subgoal_uses_tool(rough):
            raise ValueError(
                ...
                "Planning B does not select tools"
            )
        return None
