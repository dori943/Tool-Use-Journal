...
from planning_b.conditions import subgoal_required_wrench
from planning_b.diagnostics import ReasonCode, Rejection, make_rejection
from planning_b.models import PlanningPolicy, ResourceCatalog, Subgoal
...
class GeometryCache:
    ...
    :class:`~planning_b.motion_interface.MotionFeasibilityOracle` (structured
    ...
    def check_candidate(
        ...
        if self.is_motion_oracle:
            from planning_b.motion_interface import build_candidate_query
    ...
    def check_transition(
        ...
        self.checks_executed += 1
        if self.is_motion_oracle:
            from planning_b.motion_interface import build_transition_query
    ...
    def check_ee_exchange(
        ...
        *,
        ...
        self.checks_executed += 1
        from planning_b.motion_interface import EEExchangeQuery, as_scene_ref
