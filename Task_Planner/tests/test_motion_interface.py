...
from task_planner.feasibility import CheckResult, FeasibilityStatus
from task_planner.models import PlanningPolicy
...
def test_legacy_checker_still_works_without_the_new_hooks() -> None:
    ...
    from task_planner.feasibility import AlwaysPassGeometryChecker
