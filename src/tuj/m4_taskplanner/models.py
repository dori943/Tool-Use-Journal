"""Pydantic v2 models for the normalized GK + M2 task graph."""
...
class Condition(_AliasedModel):
    ...
    in the upstream M2 judgement. ``pass=False`` does NOT mean a negative
...
class Subgoal(_AliasedModel):
    ...
    feasible_ee_source: Literal["gk", "m2", "request"] = "request"
...
class TaskConstraints(_ExtensibleModel):
    """Typed constraints attached to the normalized GK + M2 task graph."""
