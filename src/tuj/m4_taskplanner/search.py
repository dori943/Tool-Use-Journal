...
from tuj.m4_taskplanner.feasibility import FeasibilityStatus, GeometryCache
from tuj.m4_taskplanner.models import PlanningPolicy, Subgoal
from tuj.m4_taskplanner.scene import SceneState, SceneStateUpdater
from tuj.m4_taskplanner.state import SearchState, with_group_binding
...
def _scene_ref(state: SearchState):
    ...
    from tuj.m4_taskplanner.motion_interface import SceneRef
