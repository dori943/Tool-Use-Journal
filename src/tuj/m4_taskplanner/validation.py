...
from tuj.m4_taskplanner.conditions import EffectConflictError, validate_subgoal_effects
...
from tuj.m4_taskplanner.models import OrderConstraints, TaskPlannerRequest
...
def validate_request(request: TaskPlannerRequest) -> ValidationOutcome:
    ...
    if has_cycle or task_graph.order_constraints.cycle_detected:
        ...
        reject(
            ...
            + ("" if has_cycle else " (declared by M2)"),
        )
        return outcome
