...
class GeometryCache:
    ...
    :class:`~tuj.m3_taskplanner.motion_interface.MotionFeasibilityOracle` (structured
    ...
    def check_candidate(
        ...
        if self.is_motion_oracle:
            from tuj.m3_taskplanner.motion_interface import build_candidate_query
    ...
    def check_transition(
        ...
        self.checks_executed += 1
        if self.is_motion_oracle:
            from tuj.m3_taskplanner.motion_interface import build_transition_query
    ...
    def check_ee_exchange(
        ...
        *,
        ...
        self.checks_executed += 1
        from tuj.m3_taskplanner.motion_interface import EEExchangeQuery, as_scene_ref
