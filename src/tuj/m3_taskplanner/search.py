...
from tuj.m3_taskplanner.feasibility import FeasibilityStatus, GeometryCache
from tuj.m3_taskplanner.models import PlanningPolicy, Subgoal
from tuj.m3_taskplanner.scene import SceneState, SceneStateUpdater
...
def _scene_ref(state: SearchState):
    ...
    from tuj.m3_taskplanner.motion_interface import SceneRef
